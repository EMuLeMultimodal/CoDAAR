...
def main():
    ...
    if args.dataset_name == 'ucfv_vgga':
        train_csv_path = '/UCF101/data/ucf2vggsound.csv'
        val_csv_path = '/UCF101/data/vggsound2ucf.csv'
        ...
        train_csv_path = '/UCF101/data/vggsound2ucf.csv'
        val_csv_path = '/UCF101/data/ucf2vggsound.csv'
        audio_fea_base_path = '/vggsound40k/feature/audio/zip'
        video_fea_base_path = '/UCF101/feature/video/zip'
        train_dataloader = DataLoader(
