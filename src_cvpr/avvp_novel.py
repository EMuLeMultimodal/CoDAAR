...
from model.main_model_novel import Semantic_Decoder_AVVP_1, AV_VQVAE_Encoder, AVT_VQVAE_Encoder
...
def main():
    ...
    if args.dataset_name == 'avvp_va':
        ...
        multimodal_csv_path = "/AVVP/data/AVVP_multimodal_simplified.csv"
        audio_fea_base_path = '/AVVP/feature/audio/zip'
        video_fea_base_path = '/AVVP/feature/video/zip'
        train_dataloader = DataLoader(
