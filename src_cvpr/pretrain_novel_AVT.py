...
with open('/cnt_new.pkl', 'rb') as fp:
...
def main():
    ...
    if args.dataset_name == 'vggsound_AVT_90k':
        meta_csv_path = '/VGGSoundAVEL/Data/vggsound-avel90k-new.csv'
        audio_fea_base_path = '/VGGSoundAVEL/audio90k_features_new'
        video_fea_base_path = '/VGGSoundAVEL/video90k_features_keras'
        ...
        meta_csv_path = '/vggsound40k/data/vggsound-avel40k.csv'
    ...
    for epoch in range(start_epoch+1, args.n_epoch):
        ...
        save_path = os.path.join(args.model_save_path, 'CoDAAR-model-AVT-{}.pt'.format(epoch))
